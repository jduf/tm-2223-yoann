...
for i in range(10000000):
    n_body = NBody(
        [
            ...
            Active_Body(0.2887e-17, 0, - 0.069,
                        round(random.uniform(100, 130), 6),
                        round(random.uniform(30, 60), 6), 0.002678, 10, False)
    ...
    while integrator.t < 0.278:
        ...
        # Calculez la distance entre la position actuelle
        # et la position théorique
